...
public class BoardUtils {
	...
	public final static List<String> ALGEBREIC_NOTATION = initializeAlgebreicNotation();
	public final Map<String, Integer> POSITION_AT_COORDINATE = initializePositionToCoordinateMap();
